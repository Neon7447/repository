...
if __name__ == '__main__':
    ...
    commands = {'exit': ['f_exit', 'Выход из программы'],
                ...
                'copy': ['f_copy',
                         ...
                         'copy "Каталог 1" "D:\Test\Каталог 2"          - копировать каталог из каталога по умолчанию; \n  '
                         'copy new.txt "D:\Test\Каталог 2"              - копировать файл из каталога по умолчанию'],
                'move': ['f_move',
                         'move "D:\Test\Каталог 1" "D:\Test\Каталог 2"   - переместить каталог с пробелом в имени; \n  '
